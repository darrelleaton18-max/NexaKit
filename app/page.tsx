           ...
           {/* TOOL 0: HOME DASHBOARD */}
            {activeTool === "home" && (
              <div className="flex flex-col gap-8 animate-in fade-in duration-300">
                ...
                {/* ========================================== */}
                {/* FEATURED TOOL CARDS (VISUAL ROW)           */}
                {/* ========================================== */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-2">
                  {/* Card 1: Currency Converter */}
                  <button 
                    onClick={() => setActiveTool("currency-converter")}
                    className="group flex flex-col text-left bg-white dark:bg-slate-900 rounded-2xl shadow-sm hover:shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden transition-all duration-300 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <div className="h-36 w-full bg-slate-200 dark:bg-slate-800 relative overflow-hidden">
                      <img 
                        src="https://images.unsplash.com/photo-1580519542036-c47de6196ba5?auto=format&fit=crop&q=80&w=600&h=300" 
                  ...
                  <button 
                    onClick={() => setActiveTool("qr-maker")}
                    className="group flex flex-col text-left bg-white dark:bg-slate-900 rounded-2xl shadow-sm hover:shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden transition-all duration-300 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <div className="h-36 w-full bg-slate-200 dark:bg-slate-800 relative overflow-hidden">
                      <img 
                        src="https://images.unsplash.com/photo-1595079676339-1534801ad6cb?auto=format&fit=crop&q=80&w=600&h=300" 
                  ...
                  {/* Card 3: Spinning Decision Wheel */}
                  <button 
                    onClick={() => setActiveTool("wheel-gen")}
                    className="group flex flex-col text-left bg-white dark:bg-slate-900 rounded-2xl shadow-sm hover:shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden transition-all duration-300 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <div className="h-36 w-full bg-slate-200 dark:bg-slate-800 relative overflow-hidden">
                      <img 
                        src="https://images.unsplash.com/photo-1611867104332-ceecff8f1c8f?auto=format&fit=crop&q=80&w=600&h=300" 
                        alt="Spinning Decision Wheel" 
                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" 
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
