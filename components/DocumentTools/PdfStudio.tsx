...
export default function PdfStudio() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 bg-white dark:bg-neutral-900 rounded-3xl p-6 shadow-sm border border-neutral-200 dark:border-neutral-800 min-h-[600px]">
      
      {/* STUDIO SIDEBAR */}
      <div className="w-full md:w-64 shrink-0 flex flex-col gap-2 border-b md:border-b-0 md:border-r border-neutral-200 dark:border-neutral-800 pb-6 md:pb-0 md:pr-6">
        <h2 className="text-sm font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider mb-2">PDF Studio</h2>
        
        <button 
          onClick={() => { setActiveTab("merge"); setFiles([]); }}
          className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all ${
            activeTab === "merge" ? "bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-sky-400" : "text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800"
          }`}
        >
        ...
        <button 
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all ${
            activeTab === "split" ? "bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-sky-400" : "text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800"
          }`}
        >
        ...
        <button 
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all ${
            activeTab === "rotate" ? "bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-sky-400" : "text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800"
          }`}
        >
        ...
        <button 
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all ${
            activeTab === "watermark" ? "bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-sky-400" : "text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800"
          }`}
        >
        ...
        <button 
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all ${
            activeTab === "protect" ? "bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400" : "text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800"
          }`}
        >
      ...
      <div className="flex-1 flex flex-col">
        ...
        {(activeTab === "merge" || (activeTab !== "merge" && files.length === 0)) && (
          <div 
            ...
            className={`w-full border-2 border-dashed border-neutral-300 dark:border-neutral-700 hover:border-orange-500 dark:hover:border-sky-400 bg-neutral-50 dark:bg-neutral-800/50 rounded-2xl p-10 flex flex-col items-center justify-center cursor-pointer transition-all mb-6 group ${activeTab === "protect" ? "hover:border-emerald-500 dark:hover:border-emerald-400" : ""}`}
          >
            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform ${activeTab === "protect" ? "bg-emerald-100 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400" : "bg-orange-100 dark:bg-orange-900/40 text-orange-600 dark:text-sky-400"}`}>
              {activeTab === "protect" ? (
            ...
            <span className="text-xs text-neutral-400 mt-2">Max file size: {MAX_FILE_SIZE_MB}MB (Client-side restriction)</span>
            <input 
              type="file" 
              ref={fileInputRef} 
        ...
        {files.length > 0 && (
          <div className="flex flex-col gap-4 mb-6">
            ...
            {/* Merge File List */}
            {activeTab === "merge" && (
              <div className="flex flex-col gap-3 bg-neutral-50 dark:bg-neutral-800/30 p-4 rounded-xl border border-neutral-200 dark:border-neutral-800">
                <h4 className="text-xs font-bold text-neutral-500 uppercase tracking-wider mb-1">Files to Merge ({files.length})</h4>
                {files.map((file, idx) => (
                  <div key={idx} className="flex items-center justify-between bg-white dark:bg-neutral-800 p-3 rounded-lg border border-neutral-200 dark:border-neutral-700 shadow-sm">
                    <div className="flex items-center gap-3 truncate pr-4">
                      ...
                      <span className="text-sm font-semibold text-neutral-700 dark:text-neutral-200 truncate">{file.name}</span>
                    </div>
                    <button onClick={() => removeFile(idx)} className="text-neutral-400 hover:text-red-500 transition-colors p-1">
            ...
            {/* Split Settings */}
            {activeTab === "split" && (
              <div className="flex flex-col gap-4 bg-neutral-50 dark:bg-neutral-800/30 p-5 rounded-xl border border-neutral-200 dark:border-neutral-800">
                <div className="flex items-center justify-between border-b border-neutral-200 dark:border-neutral-700 pb-4">
                  <div className="flex items-center gap-3 truncate pr-4">
                    ...
                    <span className="text-sm font-semibold text-neutral-700 dark:text-neutral-200 truncate">{files[0].name}</span>
                  </div>
                  <button onClick={() => setFiles([])} className="text-xs font-bold text-neutral-400 hover:text-red-500 transition-colors">
                    Change File
                  </button>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 text-neutral-800 dark:text-white placeholder:text-neutral-400"
                  />
            ...
            {activeTab === "rotate" && (
              <div className="flex flex-col gap-4 bg-neutral-50 dark:bg-neutral-800/30 p-5 rounded-xl border border-neutral-200 dark:border-neutral-800">
                ...
                <div>
                  <label className="block text-sm font-bold text-neutral-700 dark:text-neutral-200 mb-3">
                    Select Rotation Angle
                  </label>
                  <div className="grid grid-cols-3 gap-3">
                    <button 
                      onClick={() => setRotationAngle(90)} 
                      className={`py-3 rounded-lg text-sm font-bold border transition-all ${rotationAngle === 90 ? "bg-orange-50 border-orange-600 text-orange-700 dark:bg-orange-900/30 dark:border-sky-400 dark:text-sky-400" : "bg-white border-neutral-200 text-neutral-600 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-300 hover:border-orange-300"}`}
                    >
                      90° Right
                    </button>
                    <button 
                      onClick={() => setRotationAngle(270)} 
                      className={`py-3 rounded-lg text-sm font-bold border transition-all ${rotationAngle === 270 ? "bg-orange-50 border-orange-600 text-orange-700 dark:bg-orange-900/30 dark:border-sky-400 dark:text-sky-400" : "bg-white border-neutral-200 text-neutral-600 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-300 hover:border-orange-300"}`}
                    >
                      90° Left
                    </button>
                    <button 
                      onClick={() => setRotationAngle(180)} 
                      className={`py-3 rounded-lg text-sm font-bold border transition-all ${rotationAngle === 180 ? "bg-orange-50 border-orange-600 text-orange-700 dark:bg-orange-900/30 dark:border-sky-400 dark:text-sky-400" : "bg-white border-neutral-200 text-neutral-600 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-300 hover:border-orange-300"}`}
                    >
                      180° Flip
                    </button>
                  </div>
              ...
              <div className="flex flex-col gap-4 bg-neutral-50 dark:bg-neutral-800/30 p-5 rounded-xl border border-neutral-200 dark:border-neutral-800">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 text-neutral-800 dark:text-white placeholder:text-neutral-400"
                  />
                  <p className="text-[11px] font-medium text-neutral-500 mt-2">
              ...
              ((activeTab === "merge" && files.length >= 2) || 
               ...
               (activeTab === "protect" && files.length > 0 && securePassword)) && !isProcessing
                ? activeTab === "protect" 
                  ...
                  : "bg-orange-600 hover:bg-orange-700 text-white shadow-md hover:shadow-lg hover:-translate-y-0.5" 
